                ...
                <div id="container">
                    ...
                    try {
                        IF ($_SESSION['Login'] == "Yes") {
                            ...
                            $prog = $mysqli->query("SELECT DISTINCT project.Project_ID, project.Title FROM project
                                                    JOIN userAccess ON project.Project_ID=userAccess.projectId
                                                    WHERE userAccess.userId=" . $_SESSION['UID'] . ";");
                            $prog->data_seek(0);
